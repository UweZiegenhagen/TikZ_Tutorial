...
\node [below right = 3cm and 5cm of a] {3d5r};
\end{tikzpicture}}
\end{center}
...
\begin{itemize}
\item TikZ = Wow\ldots
\item Steile Lernkurve, Diagramme werden mehr \enquote{programmiert} 
\item Syntax ist speziell, wenn man von PS*Tricks etc. kommt
\item Ergebnisse überzeugen aber
\end{itemize}
\end{frame}
